...
[pt.c] /dev/mem opened!
[idt.c] established user space IDT mapping at 0x7fb6d7176000
[idt.c] installed ring3 asm IRQ handler with target_rip=0x5621ee882d9e
[idt.c] IDT[ 45] @0x7fb6d71762d0 = 0x5621ee882d9e (seg sel 0x33); p=1; dpl=3; type=15; ist=0
...
[apic.c] established local memory mapping for APIC_BASE=0xfee00000 at 0x7fb6d7175000
...
[idt.c] installed ring0 IRQ handler with target_rip=0x5621ee882d9e
[idt.c] IDT[ 45] @0x7fb6d71762d0 = 0x5621ee882d9e (seg sel 0x10); p=1; dpl=3; type=15; ist=0
[idt.c] installing and calling ring0 irq gate
[sched.c] continuing on CPU 1
[idt.c] DTR.base=0xfffffe0000000000/size=4095 (256 entries)
[idt.c] established user space IDT mapping at 0x7fb6d7174000
[idt.c] installed ring0 IRQ handler with target_rip=0x5621ee882e2e
[idt.c] IDT[ 49] @0x7fb6d7174310 = 0x5621ee882e2e (seg sel 0x10); p=1; dpl=3; type=15; ist=0
